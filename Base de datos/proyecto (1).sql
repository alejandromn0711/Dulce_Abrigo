...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-02-2021 a las 21:07:34
...
(26, 'Teladdd3', 'dsfasf', 12222, 12, 'fondo-azul-marino.jpg', 1);
...
--
ALTER TABLE `carrito_compra`
  ADD CONSTRAINT `carrito_compra_ibfk_1` FOREIGN KEY (`idcliente`) REFERENCES `cliente` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pedido`
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`idcarrito`) REFERENCES `carrito_compra` (`idcarrito`) ON DELETE CASCADE ON UPDATE CASCADE;
