...
<div class="categorias_var">
    <ul>
        <li><a href=""><img src="img/catColchon.jpg"><br>COLCHONES</a></li>
        <li><a href=""><img src="img/catAlmohada.jpg"><br>ALMOHADAS</a></li>
        <li><a href=""><img src="img/catSabana.jpg"><br>SABANAS</a></li>
        <li><a href=""><img src="img/catBase.jpg"><br>BASE CAMAS</a></li>
        <li><a href=""><img src="img/catTela.jpg"><br>TELAS</a></li>
