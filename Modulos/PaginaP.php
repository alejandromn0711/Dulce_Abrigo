    ...
    <div class="container">
        <div class="row my-5">
            ...
            <div class="col-md-4 my-4">
                <img src="./img/colchon1.jpg" alt="" class="w-100">
                <h4 class="my-4">Colchones</h4>
                <p>Insertar texto...</p>
                <a href="#" class="btn btn-outline-dark btn-md">Ver productos...</a>
            </div>

            <div class="col-md-4 my-4">
                <img src="./img/colchon4.jpg" alt="" class="w-100">
                <h4 class="my-4">Colchones</h4>
                <p>Insertar texto...</p>
                <a href="#" class="btn btn-outline-dark btn-md">Ver productos...</a>
            </div>
            ...
            <div class="col-md-4 my-4">
                <img src="./img/colchon3.jpg" alt="" class="w-100">
                <h4 class="my-4">Colchones</h4>
                <p>Insertar texto...</p>
                <a href="#" class="btn btn-outline-dark btn-md">Ver productos...</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 col-lg-4 col-xl-3 pt-4 pt-md-0">
                    <a href="#" class="btn btn-outline-dark">Ver productos</a>
                </div>
            </div>
        </div>
    </div>
