...
?>
<h1 style="margin-top: 100px;;">Administra Los Productos</h1><br>
<a href="?p=AñadirPro" class="btn btn-success" style="max-width:150px; float:right; margin-right:100px;" >Añadir Un Nuevo Producto  <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-folder-plus" viewBox="0 0 16 16">
