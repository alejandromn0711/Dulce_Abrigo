                            ...
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="?p=VerPro">Productos</a>
                                        <a class="dropdown-item" href="?p=VerClientes">Clientes</a>
                                        <a class="dropdown-item" href="?p=PedidosADMI">Pedidos</a>
                                        <a class="dropdown-item" href="?p=FacturasADMI">Facturas</a>
